...
# создаем словарь со значениями букв для английского алфавита
english_scores = {'A': 1, 'B': 3, 'C': 3, 'D': 2, 'E': 1, 'F': 4, 'G': 2, 'H': 4, 
                  'I': 1, 'J': 8, 'K': 5, 'L': 1, 'M': 3, 'N': 1, 'O': 1, 'P': 3, 
                  'Q': 10, 'R': 1, 'S': 1, 'T': 1, 'U': 1, 'V': 4, 'W': 4, 'X': 8, 
                  'Y': 4, 'Z': 10}

# создаем словарь со значениями букв для русского алфавита
...
word = input().upper() # считываем слово и переводим все буквы в верхний регистр
score = 0 # начальное значение счета равно нулю

# выбираем соответствующий словарь для подсчета очков
if all([letter in english_scores for letter in word]): # если все буквы в слове английские
    scores = english_scores
else: # иначе все буквы в слове русские
    scores = russian_scores

# считаем сумму очков для каждой буквы в слове
for letter in word:
    score += scores[letter]
